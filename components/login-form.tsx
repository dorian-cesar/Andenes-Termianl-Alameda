    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-border/50 backdrop-blur-sm bg-card/95 animate-scale-in relative z-10">
        <CardHeader className="space-y-3 text-center">
          ...
          <CardTitle className="text-3xl font-bold text-foreground">Terminal de Buses</CardTitle>
          <CardDescription className="text-base text-muted-foreground">Sistema de Control de Andenes</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground transition-smooth hover-lift"
              disabled={isLoading}
            >
            ...
            <div className="mt-6 p-4 bg-muted/50 border border-border rounded-lg space-y-2 text-sm">
              ...
              <p className="text-muted-foreground">
                Admin: <span className="text-primary">admin@terminal.com</span> / admin123
              </p>
              <p className="text-muted-foreground">
                Operador: <span className="text-secondary">operador@terminal.com</span> / operador123
              </p>
            </div>
          </form>
        </CardContent>
